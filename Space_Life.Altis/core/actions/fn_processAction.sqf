...
_itemInfo = switch (_type) do {
    ...
    case "meth1": {["Meth0","Meth1",10000,(localize "STR_Process_Meth"),false];};
    case "meth2": {["Meth1","Meth2",10000,(localize "STR_Process_Meth"),false];};
    case "meth3": {["Meth2","Meth3",10000,(localize "STR_Process_Meth"),false];};
	default {[];};
};
